...
``` bash
wget https://github.com/infection/infection/releases/download/0.4.0/infection.phar
wget https://github.com/infection/infection/releases/download/0.4.0/infection.phar.pubkey
