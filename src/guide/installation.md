...
``` bash
wget https://github.com/infection/infection/releases/download/0.26.22/infection.phar
wget https://github.com/infection/infection/releases/download/0.26.22/infection.phar.asc
