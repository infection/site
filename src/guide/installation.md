...
``` bash
wget https://github.com/infection/infection/releases/download/0.5.3/infection.phar
wget https://github.com/infection/infection/releases/download/0.5.3/infection.phar.pubkey
