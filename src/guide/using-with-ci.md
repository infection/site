...
``` yml
before_script:
    - wget https://github.com/infection/infection/releases/download/0.5.2/infection.phar
    - wget https://github.com/infection/infection/releases/download/0.5.2/infection.phar.pubkey
