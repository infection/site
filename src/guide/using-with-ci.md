...
``` yml
before_script:
    - wget https://github.com/infection/infection/releases/download/0.6.1/infection.phar
    - wget https://github.com/infection/infection/releases/download/0.6.1/infection.phar.pubkey
